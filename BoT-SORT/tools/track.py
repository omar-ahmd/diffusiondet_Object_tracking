...
def make_parser():
    ...
    parser.add_argument("-expn", "--experiment-name", type=str, default='exp2')
    ...
    for ext in seqs_ext:
        for i in seqs:
            ...
            if args.default_parameters:
                ...
                if MOT == 20:  # MOT20
                    args.exp_file = r'BoT-SORT/yolox/exps/example/mot/yolox_x_mix_mot20_ch.py'
                    args.ckpt = r'BoT-SORT/pretrained/bytetrack_x_mot20.tar'
                    args.match_thresh = 0.7
                else:  # MOT17
                    if ablation:
                        args.exp_file = r'BoT-SORT/yolox/exps/example/mot/yolox_x_ablation.py'
                        args.ckpt = r'BoT-SORT/pretrained/bytetrack_ablation.pth.tar'
                    else:
                        args.exp_file = r'BoT-SORT/yolox/exps/example/mot/yolox_x_mix_det.py'
                        args.ckpt = r'BoT-SORT/pretrained/bytetrack_x_mot17.pth.tar'
